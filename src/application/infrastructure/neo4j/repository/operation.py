...
class Neo4jRepositoryOperationContextFactory:
    ...
    def __init__(
        ...
        *,
        ...
        self._database_name = require_non_blank(
    ...
    def create(
        ...
        *,
        ...
        return Neo4jRepositoryOperationContext(
            repository_name=require_non_blank(
                owner=self.__class__.__name__,
                field_name="repository_name",
                value=repository_name,
            ),
            operation_name=require_non_blank(
                owner=self.__class__.__name__,
                field_name="operation_name",
                value=operation_name,
            ),
            access_mode=access_mode,
            statement_name=require_non_blank(
                owner=self.__class__.__name__,
                field_name="statement_name",
                value=statement_name,
            ),
            database_name=self._database_name,
            correlation_id=require_non_blank(
                owner=self.__class__.__name__,
